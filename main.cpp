...
private:
    ...
    //si am cautat si aflat ca sunt comparabile in performanta
    ...
    string timpJucatCaString() const {
        ...
        if (timpJucat < 60) { //sub 60 minute
            timp = "Te-ai jucat " + nume + " timp de " + to_string(timpJucat) + " de minute";
        }
        else { //peste 60 minute
            int ore = timpJucat / 60;
            int minute = timpJucat % 60;
            timp = "Te-ai jucat " + nume + " timp de " + to_string(ore) + " ore";
            if (minute > 0) {
...
public:
    //constructor
    Joc(string nume, int id, string dataLansarii, int timpJucat) {
        this->nume = nume;
        this->id = id;
        this->dataLansarii = dataLansarii;
        this->timpJucat = timpJucat;
    }
